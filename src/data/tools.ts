...
{ id: 'reorder-pages', name: 'Reorder Pages', nameAr: 'إعادة ترتيب الصفحات', description: 'Rearrange pages in a PDF document', descriptionAr: 'إعادة ترتيب الصفحات في مستند PDF', icon: ArrowUpDown, category: 'office' },
{ id: 'rotate-pages', name: 'Rotate Pages', nameAr: 'تدوير الصفحات', description: 'Rotate individual pages in a PDF', descriptionAr: 'تدوير صفحات فردية في PDF', icon: RotateCw, category: 'office' },
{ id: 'password-protect', name: 'Password Protect', nameAr: 'حماية بكلمة مرور', description: 'Add password protection to PDF files', descriptionAr: 'إضافة حماية بكلمة مرور لملفات PDF', icon: Lock, category: 'office' },
{ id: 'remove-password', name: 'Remove Password', nameAr: 'إزالة كلمة المرور', description: 'Remove password protection from PDF files', descriptionAr: 'إزالة حماية كلمة المرور من ملفات PDF', icon: Unlock, category: 'office' },
{ id: 'add-watermark', name: 'Add Watermark', nameAr: 'إضافة علامة مائية', description: 'Add text or image watermarks to PDF files', descriptionAr: "إضافة علامات مائية نصية أو صور إلى ملفات PDF", icon: Droplets, category: "office" },
{ id:'add-signature', name:'Add Signature', nameAr:'إضافة توقيع', description:'Add digital signatures to PDF documents', descriptionAr: 'إضافة توقيعات رقمية إلى مستندات PDF', icon:Signature, category:'office' },
{ id:'extract-images', name:'Extract Images', nameAr:'استخراج الصور', description:'Extract images from PDF files', descriptionAr: 'استخراج الصور من ملفات PDF', icon: ImageIcon, category:'office' },
{ id:'ocr', name:'OCR', nameAr:'التعرف الضوئي', description:'Optical character recognition for scanned PDFs', descriptionAr:'التعرف البصري على الأحرف لملفات PDF الممسوحة ضوئياً', icon:ScanSearch, category:'office' },
{ id: 'scan-to-text', name: 'Scan to Text', nameAr: 'مسح إلى نص', description: 'Convert scanned documents and images to editable text', descriptionAr: 'تحويل المستندات والصور الممسوحة ضوئياً إلى نص قابل للتعديل', icon: ScanText, category: 'office' },
{ id: 'compare-pdfs', name: 'Compare PDFs', nameAr: 'مقارنة PDF', description: 'Compare two PDF files and highlight differences', descriptionAr: 'مقارنة ملفي PDF وإبراز الاختلافات', icon: GitCompare, category: 'office' },
 // AI
...
{ id: 'summarize-images', name: 'Summarize Images', nameAr: 'تلخيص الصور', description: 'Extract and summarize text from images', descriptionAr: 'استخراج وتلخيص النص من الصور', icon: FileImage, category: 'ai' },
{ id: 'summarize-youtube', name: 'Summarize YouTube', nameAr: 'تلخيص يوتيوب', description: 'Summarize YouTube video content', descriptionAr: 'تلخيص محتوى فيديوهات يوتيوب', icon: PlaySquare, category: 'ai' },
{ id: 'summarize-audio', name: 'Summarize Audio', nameAr: 'تلخيص الصوت', description: 'Transcribe and summarize audio recordings', descriptionAr: 'نسخ وتلخيص التسجيلات الصوتية', icon: Music, category: 'ai' },
{ id: 'explain-simply', name: 'Explain Simply', nameAr: 'شرح مبسط', description: 'Explain complex topics in simple terms', descriptionAr: 'شرح المواضيع المعقدة بعبارات بسيطة', icon: Lightbulb, category: 'ai' },
{ id: 'rewrite-text', name: 'Rewrite Text', nameAr: 'إعادة كتابة النص', description: 'Rewrite text in different styles and tones', descriptionAr: 'إعادة كتابة النص بأساليب ونغمات مختلفة', icon: Pen, category: 'ai' },
{ id: 'grammar-check', name: 'Grammar Check', nameAr: 'تدقيق نحوي', description: 'Check and correct grammar and spelling errors', descriptionAr: 'التحقق وتصحيح أخطاء القواعد والإملاء', icon: CheckCircle, category: 'ai' },
...
{ id: 'paragraph-to-bullets', name: 'Paragraph to Bullets', nameAr: 'فقرة إلى نقاط', description: 'Convert paragraphs into bullet point summaries', descriptionAr: 'تحويل الفقرات إلى نقاط تلخيصية', icon: List, category: 'ai' },
{ id: 'bullets-to-article', name: 'Bullets to Article', nameAr: 'نقاط إلى مقال', description: 'Expand bullet points into a full article', descriptionAr: 'توسيع النقاط إلى مقال كامل', icon: Newspaper, category: 'ai' },
{ id: 'extract-key-ideas', name: 'Extract Key Ideas', nameAr: 'استخراج الأفكار الرئيسية', description: 'Identify and extract key ideas from text', descriptionAr: 'تحديد واستخراج الأفكار الرئيسية من النص', icon: Key, category: 'ai' },
{ id: 'generate-mcqs', name: 'Generate MCQs', nameAr: 'إنشاء أسئلة اختيار', description: 'Generate multiple choice questions from content', descriptionAr: 'إنشاء أسئلة اختيار من متعدد من المحتوى', icon: HelpCircle, category: 'ai' },
{ id: 'generate-tf', name: 'Generate True/False', nameAr: 'إنشاء صح/خطأ', description: 'Generate true/false questions from content', descriptionAr: 'إنشاء أسئلة صح أو خطأ من المحتوى', icon: Zap, category: 'ai' },
...
{ id: 'generate-quiz', name: 'Generate Quiz', nameAr: 'إنشاء اختبار', description: 'Create a complete quiz from any content', descriptionAr: 'إنشاء اختبار كامل من أي محتوى', icon: BookOpenCheck, category: 'ai' },
{ id: 'generate-study-plan', name: 'Generate Study Plan', nameAr: 'إنشاء خطة دراسة', description: 'Create a personalized study plan', descriptionAr: 'إنشاء خطة دراسة مخصصة', icon: CalendarDays, category: 'ai' },
{ id: 'generate-mindmap', name: 'Generate Mind Map', nameAr: 'إنشاء خريطة ذهنية', description: 'Create visual mind maps from text content', descriptionAr: 'إنشاء خرائط ذهنية مرئية من المحتوى النصي', icon: BrainCircuit, category: 'ai' },
{ id: 'extract-terminology', name: 'Extract Terminology', nameAr: 'استخراج المصطلحات', description: 'Extract key terms and definitions from content', descriptionAr: 'استخراج المصطلحات والتعريفات الرئيسية من المحتوى', icon: Book, category: 'ai' },
{ id: 'explain-terminology', name: 'Explain Terminology', nameAr: 'شرح المصطلحات', description: 'Get simple explanations of complex terminology', descriptionAr: 'الحصول على شروحات بسيطة للمصطلحات المعقدة', icon: Type, category: 'ai' },
{ id: 'simplify-paper', name: 'Simplify Paper', nameAr: 'تبسيط ورقة بحثية', description: 'Simplify academic papers for better understanding', descriptionAr: 'تبسيط الأوراق الأكاديمية لفهم أفضل', icon: Microscope, category: 'ai' },
 // POWERPOINT
{
...
{ id: 'compress-video', name: 'Compress Video', nameAr: 'ضغط الفيديو', description: 'Reduce video file size while maintaining quality', descriptionAr: 'تقليل حجم ملف الفيديو مع الحفاظ على الجودة', icon: Minimize2, category: 'video' },
{ id: 'convert-video', name: 'Convert Video', nameAr: 'تحويل الفيديو', description: 'Convert videos between different formats', descriptionAr: 'تحويل الفيديوهات بين صيغ مختلفة', icon: ArrowLeftRight, category: 'video' },
...
{ id: 'rotate-image', name: 'Rotate Image', nameAr: 'تدوير الصورة', description: 'Rotate images to any angle', descriptionAr: 'تدوير الصور بأي زاوية', icon: RotateCw, category: 'images' },
{ id: 'blur-image', name: 'Blur Image', nameAr: 'تعتيم الصورة', description: 'Blur parts or whole images', descriptionAr: 'تعتيم أجزاء أو الصورة كاملة', icon: Droplet, category: 'images' },
{ id: 'images-to-pdf', name: 'Images to PDF', nameAr: 'صور إلى PDF', description: 'Convert multiple images into a PDF document', descriptionAr: 'تحويل صور متعددة إلى مستند PDF', icon: FileImage, category: 'images' },
...
// MEDICAL
{ id: 'medical-summarizer', name: 'Medical Summarizer', nameAr: 'ملخص طبي', description: 'Summarize medical texts and articles', descriptionAr: 'تلخيص النصوص والمقالات الطبية', icon: FileHeart, category: 'medical' },
