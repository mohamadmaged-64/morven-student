...
const toolDetails: Record<string, { en: string; ar: string }> = {
  ...
  'summarize-word': { en: 'Upload Word documents and get an AI-generated summary highlighting the most important content. Save time on lengthy academic papers and reports.', ar: 'ارفع مستندات Word واحصل على ملخص مولّد بالذكاء الاصطناعي يبرز المحتوى الأهم. وفّر الوقت في الأوراق الأكاديمية والتقارير الطويلة.' },
  'summarize-ppt': { en: 'Extract and summarize the key content from PowerPoint presentations. Get the main points, conclusions, and important data without reviewing every slide.', ar: 'استخرج ولخّص المحتوى الرئيسي من عروض PowerPoint التقديمية. احصل على النقاط الرئيسية والاستنتاجات والبيانات المهمة دون مراجعة كل شريحة.' },
  ...
  'extract-key-ideas': { en: 'Identify and extract the core ideas, themes, and arguments from any text. Essential for research, studying, and critical analysis of academic content.', ar: 'حدد واستخرج الأفكار الجوهرية وال主题 والحجج من أي نص. ضروري للبحث والدراسة والتحليل النقدي للمحتوى الأكاديمي.' },
