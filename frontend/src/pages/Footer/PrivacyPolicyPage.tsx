...
const policySections = [
  {
    ...
    content: 'مورفن مصمم لتقليل جمع البيانات. عند زيارتك لموقعنا، قد نجمع تلقائياً معلومات تقنية أساسية مثل نوع المتصفح والنظام التشغيلي والصفحات التي تمت زيارتها، فقط لأغراض صيانة وتحسين الخدمة. لا نجمع معلومات تعريف شخصية إلا إذا قدمتها طوعياً — على سبيل المثال، بإرسال لنا رسالة عبر صفحة الاتصال. عند استخدام أدوات معالجة الملفات، تُعالج الملفات التي ترفعها كما هو موضح في قسم معالجة الملفات أدناه.',
  },
  {
    icon: FileText,
    title: 'معالجة الملفات',
    content: 'تتم معالجة ملفاتك في معظم أدوات مورفن بالكامل في متصفحك باستخدام JavaScript جانب العميل. هذا يعني أن ملفاتك لا تغادر جهازك ولا تُرسل إلى أي خادم. لأدوات معينة تتطلب معالجة جانب الخادم (مثل تحويل مستندات Office إلى PDF)، تُرسل الملفات إلى خوادمنا عبر اتصال مشفّر. تُعالج هذه الملفات فوراً وتُحذف بشكل دائم خلال ثوانٍ من اكتمال العملية. لا نقرأ أو نحلل أو نحتفظ بأي محتوى من ملفاتك.',
  },
  {
    icon: Globe,
    title: 'الخدمات الخارجية',
    content: 'لا يتكامل مورفن مع أي خدمات تحليلات أو إعلانات أو تتبع تابعة لجهات خارجية. لا نستخدم Google Analytics أو Facebook Pixel أو أدوات مماثلة. موقعنا يعمل بشكل مستقل ولا يحمّل نصوصاً خارجية لأغراض التتبع أو الإعلانات. إذا تغير هذا في المستقبل، سيتم تحديث هذه السياسة وفقاً لذلك.',
  },
  {
    icon: UserCheck,
    title: 'حقوقك',
    content: 'لديك الحق في معرفة البيانات التي نجمعها وكيف تُستخدم. نظراً لأننا نجمع بيانات محدودة ولا نحتفظ بمحتوى الملفات، هناك القليل من البيانات الشخصية التي يمكن طلبها. إذا تواصلت معنا عبر صفحة الاتصال، يمكنك طلب حذف تلك المراسلة في أي وقت. يمكنك تغيير تفضيلات المظهر في أي وقت من خلال واجهة الموقع.',
  },
  {
    icon: Mail,
    title: 'معلومات الاتصال',
    content: 'إذا كان لديك أي أسئلة أو مخاوف أو طلبات تتعلق بسياسة الخصوصية هذه أو ممارسات البيانات لدينا، يرجى التواصل معنا عبر صفحة الاتصال. سنرد على استفسارك في أسرع وقت ممكن.',
  },
];
