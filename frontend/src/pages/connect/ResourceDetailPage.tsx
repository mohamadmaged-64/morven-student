...
import { typeLabels, typeIcons, typeOptions, type ResourceType } from '@/data/resources';
import {
  useResourcesStore,
  type ResourceFile,
  type ResourceLink,
} from '@/store/useResourcesStore';
import { useAuthStore } from '@/store/useAuthStore';
import { canManageResource } from '@/utils/resourcePermissions';
import {
  BookOpen,
  ChevronLeft,
  Upload,
